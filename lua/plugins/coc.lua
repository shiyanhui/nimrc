...
vim.api.nvim_set_keymap('n', '<C-N>', 'coc#float#has_scroll() ? coc#float#scroll(1) : \'<Plug>(coc-diagnostic-next)\'', {silent = true, nowait = true, expr = true})
vim.api.nvim_set_keymap('v', '<C-N>', 'coc#float#has_scroll() ? coc#float#scroll(1) : \'<Plug>(coc-diagnostic-next)\'', {silent = true, nowait = true, expr = true})
vim.api.nvim_set_keymap('i', '<C-N>', 'coc#float#has_scroll() ? "<c-r>=coc#float#scroll(1)<cr>" : ""', {silent = true, nowait = true, expr = true})
vim.api.nvim_set_keymap('n', '<C-P>', 'coc#float#has_scroll() ? coc#float#scroll(0) : \'<Plug>(coc-diagnostic-prev)\'', {silent = true, nowait = true, expr = true})
vim.api.nvim_set_keymap('v', '<C-P>', 'coc#float#has_scroll() ? coc#float#scroll(0) : \'<Plug>(coc-diagnostic-prev)\'', {silent = true, nowait = true, expr = true})
vim.api.nvim_set_keymap('i', '<C-P>', 'coc#float#has_scroll() ? "<c-r>=coc#float#scroll(0)<cr>" : ""', {silent = true, nowait = true, expr = true})
